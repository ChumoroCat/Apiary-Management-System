...
"use strict";
    $(document).ready(function(){
        ...
        for (let i = 0; i < btnsOpenWindowEdit.length; i++){
            ...
            document.querySelector('#inspection-record-observation-edit').value = document.querySelector('#a' + + btnsOpenWindowEdit[i].id + ' > .inspection-record-detail-observation').innerHTML;
            //--------------------------------------------------------------------------->
            ...
            $(".form-container-edit").submit(function(){
                ...
                var observationV = document.querySelector('#inspection-record-observation-edit').value;

                $.post("update scripts/update-inspection-record.php", 
                { 
                    inspectionID: btnsOpenWindowEdit[i].id,
                    observation: observationV, 
                }, function()
                {
                    $(".submit-text").text("Inspection Updated!");
                    location.reload();
                });
            });
